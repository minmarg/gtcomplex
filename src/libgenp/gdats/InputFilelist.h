...
public:
    ...
    const size_t& GetMasterFileCounter() const {return masterfilecounter_;}
    size_t& GetMasterFileCounter() {return masterfilecounter_;}
...
private:
    ...
    size_t masterfilecounter_;//file counter for clustering
