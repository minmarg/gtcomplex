...
//     //}}
        ...
        TSCounterVar* tscnt)
    {
        ...
        mstr_set_qrycpxsernrbeg_ = qrycpxsernrbeg;
...
//         cbpc.SetQueryLen(nqrsposs_);
    ...
    void CopyDataOnMsgProcessNewData(CuBatch&)
    {
        ...
        {   std::lock_guard<std::mutex> lck(mx_dataccess_);
            ...
            qrycpxsernrbeg_ = mstr_set_qrycpxsernrbeg_;
...
private:
    ...
    int qrycpxsernrbeg_;//serial number of the first query complex in the chunk
