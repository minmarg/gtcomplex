...
public:
    ...
    void ProcessBlockComplexHelper(
        float scorethld,
        int qrycpxsernrbeg,
        int qrysernrbeg,
        const char** querydesc,
...
protected:
    ...
    void FilteroutReferences(
        ...
        char** bdbCpmbeg,
        char** bdbCpmend,
        const size_t nqyposs, const size_t nqystrs, const size_t nqycpxs,
        const size_t ndbCposs, const size_t ndbCstrs, const size_t ndbCmpxs,
        const size_t dbstr1len, const size_t dbstrnlen,
        const size_t dbxpad, const size_t maxnsteps,
        size_t& ndbCposs2, size_t& ndbCstrs2, size_t& ndbCmpxs2,
