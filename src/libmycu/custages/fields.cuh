...
// -------------------------------------------------------------------------
// -------------------------------------------------------------------------
// GetDbComplexAddressLength: get a reference complex's address and length;
__device__ __forceinline__
void GetDbComplexAddressLength(int dbcpxndx, int& address, int& length)
{
    int dbcpxN = GetDbStrField<INTYPE,pcx2DN>(dbcpxndx);//#complex chains
    int dbcpxDstN = (int)GetDbStrField<LNTYPE,pcx2DDstN>(dbcpxndx);////#chains up to complex dbstrndx
    int dbcpxC0addr = (int)GetDbStrField<LNTYPE,pps2DDist>(dbcpxDstN);
    ...
    length = dbcpxCN1len + dbcpxCN1addr - dbcpxC0addr;
    address = dbcpxC0addr;
}

// -------------------------------------------------------------------------
// GetDbComplexAddressLength: get a query complex's address and length;
__device__ __forceinline__
void GetQueryComplexAddressLength(int qrycpxndx, int& address, int& length)
{
    int qrycpxN = GetQueryStrField<INTYPE,pcx2DN>(qrycpxndx);
    int qrycpxDstN = (int)GetQueryStrField<LNTYPE,pcx2DDstN>(qrycpxndx);
    int qrycpxC0addr = (int)GetQueryStrField<LNTYPE,pps2DDist>(qrycpxDstN);
    ...
    length = qrycpxCN1len + qrycpxCN1addr - qrycpxC0addr;
    address = qrycpxC0addr;
}
