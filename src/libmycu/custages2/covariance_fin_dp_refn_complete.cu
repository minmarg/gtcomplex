...
// 
template<bool D0FINAL, int CHCKDST, bool TFM_DINV, bool COMPLEX>
__global__ 
...
//     __shared__ float tfmCache[twmvEndOfCCDataExt];//twmvEndOfCCDataExt>nTTranformMatrix
    ...
    int fraglen;//fragment position and length
...
// Instantiations
// 
#define INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase1(tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX) \
    template __global__ void FinalFragmentBasedDPAlignmentRefinementPhase1 \
        <tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX>( \
...
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase1(false,CHCKDST_CHECK,false,false);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase1(false,CHCKDST_CHECK,true,false);

INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase1(false,CHCKDST_CHECK,false,true);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase1(false,CHCKDST_CHECK,true,true);
// =========================================================================
...
// Instantiations
//
#define INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2(tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX) \
    template __global__ void FinalFragmentBasedDPAlignmentRefinementPhase2 \
        <tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX>( \
            const int nmaxconvit, /*const uint nqystrs,*/ \
            const uint ndbCstrs, const uint ndbCposs, const uint dbxpad, \
...
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2(false,CHCKDST_CHECK,false,false);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2(false,CHCKDST_CHECK,true,false);

INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2(false,CHCKDST_CHECK,false,true);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2(false,CHCKDST_CHECK,true,true);
...
// Instantiations
//
#define INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch(tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX) \
    template __global__ void FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch \
        <tpD0FINAL,tpCHCKDST,tpTFM_DINV,tpCOMPLEX>( \
            const int nmaxconvit, /*const uint nqystrs,*/ \
            const uint ndbCstrs, const uint ndbCposs, const uint dbxpad, \
            const uint nmaxsubfrags, const uint maxnfragfcts, const uint maxnsteps, \
...
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch(false,CHCKDST_CHECK,false,false);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch(false,CHCKDST_CHECK,true,false);

INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch(false,CHCKDST_CHECK,false,true);
INSTANTIATE_FinalFragmentBasedDPAlignmentRefinementPhase2_fullsearch(false,CHCKDST_CHECK,true,true);
// =========================================================================
